...
set(CMAKE_C_FLAGS_RELEASE_INIT        "-Oz -DNDEBUG")
set(CMAKE_C_FLAGS_RELWITHDEBINFO_INIT "-Oz -g -gdwarf-3 -DNDEBUG")
set(CMAKE_INCLUDE_SYSTEM_FLAG_C "-isystem ")


set(CMAKE_ASM_FLAGS_DEBUG_INIT          "-g -gdwarf-3")
set(CMAKE_ASM_FLAGS_MINSIZEREL_INIT     "-Oz -DNDEBUG")
set(CMAKE_ASM_FLAGS_RELEASE_INIT        "-Oz -DNDEBUG")
set(CMAKE_ASM_FLAGS_RELWITHDEBINFO_INIT "-Oz -g -gdwarf-3 -DNDEBUG")
